...
## Corpus Check
- 13 files · ~10,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 127 nodes · 159 edges · 19 communities (14 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a43991c`
...
- `ensureSubtitles()` --calls--> `tickSubs()`  [EXTRACTED]
  src/content.js → src/content.js  _Bridges community 1 → community 9_
...
Cohesion: 0.14
Nodes (12): activeCue(), cueEn, cueRu, DEFAULTS, fillLineWithWords(), ICONS, positionSubs(), settings (+4 more)
...
Cohesion: 0.10
Nodes (19): author, dependencies, @vot.js/core, @vot.js/ext, @vot.js/shared, description, devDependencies, esbuild (+11 more)
...
## Knowledge Gaps
- **59 isolated node(s):** `build.sh script`, `name`, `version`, `description`, `main` (+54 more)
